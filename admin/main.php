...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><b>E-POIN TATIB</b></span>
    </a>
        ...
        <?php }*/ ?>
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu" style="border-bottom: 2px solid#aaa;">
              <li class="header text-center">Masukkan NIS Atau NAMA Siswa</li>
              <li>
...
?>
  ...
  <footer class="main-footer">
    ...
    <strong>Adapted &copy; 2023 <a href="#">SMKN 1 SINGKAWANG</a></strong> by TIM IT
  </footer>
  <!-- Control Sidebar -->
